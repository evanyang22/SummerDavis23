...
def run_trimgalore(file_path, output_dir, adapter_sequence, quality):
    command = ["trim_galore", "-a", adapter_sequence, "--fastqc", "--quality", quality, "--output_dir", output_dir, file_path]
...
def main():
    ...
    parser.add_argument("adapter_sequence", help="Adapter sequence for Trim Galore.")
